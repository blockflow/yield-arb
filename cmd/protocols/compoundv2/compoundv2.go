...
// // Skips ltv if borrow.
// func (c *CompoundV2) getTokenSpecs(symbols []string, rateMethod string) ([]*t.MarketInfo, error) {
// 	specs := make([]*t.MarketInfo, len(symbols))
...
// // Tokens are represented as their symbols
// func (c *CompoundV2) GetLendingSpecs(symbols []string) ([]*t.MarketInfo, error) {
// 	return c.getTokenSpecs(symbols, "supplyRatePerBlock")
// }

// // Returns the TokenSpecs for the specified tokens
// // Tokens are represented as their symbols
// func (c *CompoundV2) GetBorrowingSpecs(symbols []string) ([]*t.MarketInfo, error) {
// 	return c.getTokenSpecs(symbols, "borrowRatePerBlock")
// }

// // Returns the markets for the protocol
// func (c *CompoundV2) GetMarkets() (*t.ProtocolChain, error) {
