...
// IsLoopingEnabled is a free data retrieval call binding the contract method 0xbb1b7ee1.
//
// Solidity: function isLoopingEnabled(address user) view returns(bool)
func (_Comptroller *ComptrollerCaller) IsLoopingEnabled(opts *bind.CallOpts, user common.Address) (bool, error) {
	var out []interface{}
	err := _Comptroller.contract.Call(opts, &out, "isLoopingEnabled", user)
...
//
// Solidity: function isLoopingEnabled(address user) view returns(bool)
func (_Comptroller *ComptrollerSession) IsLoopingEnabled(user common.Address) (bool, error) {
	return _Comptroller.Contract.IsLoopingEnabled(&_Comptroller.CallOpts, user)
}

// IsLoopingEnabled is a free data retrieval call binding the contract method 0xbb1b7ee1.
//
// Solidity: function isLoopingEnabled(address user) view returns(bool)
func (_Comptroller *ComptrollerCallerSession) IsLoopingEnabled(user common.Address) (bool, error) {
	return _Comptroller.Contract.IsLoopingEnabled(&_Comptroller.CallOpts, user)
}
...
// LoopEnabled is a free data retrieval call binding the contract method 0xd6e5e6e6.
//
// Solidity: function loopEnabled(address ) view returns(bool)
func (_Comptroller *ComptrollerCaller) LoopEnabled(opts *bind.CallOpts, arg0 common.Address) (bool, error) {
	var out []interface{}
	err := _Comptroller.contract.Call(opts, &out, "loopEnabled", arg0)
...
//
// Solidity: function loopEnabled(address ) view returns(bool)
func (_Comptroller *ComptrollerSession) LoopEnabled(arg0 common.Address) (bool, error) {
	return _Comptroller.Contract.LoopEnabled(&_Comptroller.CallOpts, arg0)
}

// LoopEnabled is a free data retrieval call binding the contract method 0xd6e5e6e6.
//
// Solidity: function loopEnabled(address ) view returns(bool)
func (_Comptroller *ComptrollerCallerSession) LoopEnabled(arg0 common.Address) (bool, error) {
	return _Comptroller.Contract.LoopEnabled(&_Comptroller.CallOpts, arg0)
}
...
// RedeemVerify is a free data retrieval call binding the contract method 0x51dff989.
//
// Solidity: function redeemVerify(address cToken, address redeemer, uint256 redeemAmount, uint256 redeemTokens) pure returns()
func (_Comptroller *ComptrollerCaller) RedeemVerify(opts *bind.CallOpts, cToken common.Address, redeemer common.Address, redeemAmount *big.Int, redeemTokens *big.Int) error {
	var out []interface{}
	err := _Comptroller.contract.Call(opts, &out, "redeemVerify", cToken, redeemer, redeemAmount, redeemTokens)
...
//
// Solidity: function redeemVerify(address cToken, address redeemer, uint256 redeemAmount, uint256 redeemTokens) pure returns()
func (_Comptroller *ComptrollerSession) RedeemVerify(cToken common.Address, redeemer common.Address, redeemAmount *big.Int, redeemTokens *big.Int) error {
	return _Comptroller.Contract.RedeemVerify(&_Comptroller.CallOpts, cToken, redeemer, redeemAmount, redeemTokens)
}

// RedeemVerify is a free data retrieval call binding the contract method 0x51dff989.
//
// Solidity: function redeemVerify(address cToken, address redeemer, uint256 redeemAmount, uint256 redeemTokens) pure returns()
func (_Comptroller *ComptrollerCallerSession) RedeemVerify(cToken common.Address, redeemer common.Address, redeemAmount *big.Int, redeemTokens *big.Int) error {
	return _Comptroller.Contract.RedeemVerify(&_Comptroller.CallOpts, cToken, redeemer, redeemAmount, redeemTokens)
}
...
func (_Comptroller *ComptrollerCaller) ReserveGuardian(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _Comptroller.contract.Call(opts, &out, "reserveGuardian")
...
//
// Solidity: function reserveGuardian() view returns(address)
func (_Comptroller *ComptrollerSession) ReserveGuardian() (common.Address, error) {
	return _Comptroller.Contract.ReserveGuardian(&_Comptroller.CallOpts)
}

// ReserveGuardian is a free data retrieval call binding the contract method 0x0d983cc6.
//
// Solidity: function reserveGuardian() view returns(address)
func (_Comptroller *ComptrollerCallerSession) ReserveGuardian() (common.Address, error) {
	return _Comptroller.Contract.ReserveGuardian(&_Comptroller.CallOpts)
}
...
// SpeedGuardian is a free data retrieval call binding the contract method 0x1c01b48c.
//
// Solidity: function speedGuardian() view returns(address)
func (_Comptroller *ComptrollerCaller) SpeedGuardian(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _Comptroller.contract.Call(opts, &out, "speedGuardian")
...
//
// Solidity: function speedGuardian() view returns(address)
func (_Comptroller *ComptrollerSession) SpeedGuardian() (common.Address, error) {
	return _Comptroller.Contract.SpeedGuardian(&_Comptroller.CallOpts)
}

// SpeedGuardian is a free data retrieval call binding the contract method 0x1c01b48c.
//
// Solidity: function speedGuardian() view returns(address)
func (_Comptroller *ComptrollerCallerSession) SpeedGuardian() (common.Address, error) {
	return _Comptroller.Contract.SpeedGuardian(&_Comptroller.CallOpts)
}
...
// SetSpeedGuardian is a paid mutator transaction binding the contract method 0xf6f70ec1.
//
// Solidity: function _setSpeedGuardian(address newSpeedGuardian) returns()
func (_Comptroller *ComptrollerTransactor) SetSpeedGuardian(opts *bind.TransactOpts, newSpeedGuardian common.Address) (*types.Transaction, error) {
	return _Comptroller.contract.Transact(opts, "_setSpeedGuardian", newSpeedGuardian)
}

// SetSpeedGuardian is a paid mutator transaction binding the contract method 0xf6f70ec1.
//
// Solidity: function _setSpeedGuardian(address newSpeedGuardian) returns()
func (_Comptroller *ComptrollerSession) SetSpeedGuardian(newSpeedGuardian common.Address) (*types.Transaction, error) {
	return _Comptroller.Contract.SetSpeedGuardian(&_Comptroller.TransactOpts, newSpeedGuardian)
}

// SetSpeedGuardian is a paid mutator transaction binding the contract method 0xf6f70ec1.
//
// Solidity: function _setSpeedGuardian(address newSpeedGuardian) returns()
func (_Comptroller *ComptrollerTransactorSession) SetSpeedGuardian(newSpeedGuardian common.Address) (*types.Transaction, error) {
	return _Comptroller.Contract.SetSpeedGuardian(&_Comptroller.TransactOpts, newSpeedGuardian)
}
...
// EnableLooping is a paid mutator transaction binding the contract method 0xfd3c43f9.
//
// Solidity: function enableLooping(bool state) returns(bool)
func (_Comptroller *ComptrollerTransactor) EnableLooping(opts *bind.TransactOpts, state bool) (*types.Transaction, error) {
	return _Comptroller.contract.Transact(opts, "enableLooping", state)
}

// EnableLooping is a paid mutator transaction binding the contract method 0xfd3c43f9.
//
// Solidity: function enableLooping(bool state) returns(bool)
func (_Comptroller *ComptrollerSession) EnableLooping(state bool) (*types.Transaction, error) {
	return _Comptroller.Contract.EnableLooping(&_Comptroller.TransactOpts, state)
}

// EnableLooping is a paid mutator transaction binding the contract method 0xfd3c43f9.
//
// Solidity: function enableLooping(bool state) returns(bool)
func (_Comptroller *ComptrollerTransactorSession) EnableLooping(state bool) (*types.Transaction, error) {
	return _Comptroller.Contract.EnableLooping(&_Comptroller.TransactOpts, state)
}
...
// ComptrollerNewReserveGuardianIterator is returned from FilterNewReserveGuardian and is used to iterate over the raw logs and unpacked data for NewReserveGuardian events raised by the Comptroller contract.
type ComptrollerNewReserveGuardianIterator struct {
	Event *ComptrollerNewReserveGuardian // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *ComptrollerNewReserveGuardianIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ComptrollerNewReserveGuardian)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *ComptrollerNewReserveGuardianIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ComptrollerNewReserveGuardianIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// ComptrollerNewReserveGuardian represents a NewReserveGuardian event raised by the Comptroller contract.
type ComptrollerNewReserveGuardian struct {
...
func (_Comptroller *ComptrollerFilterer) FilterNewReserveGuardian(opts *bind.FilterOpts) (*ComptrollerNewReserveGuardianIterator, error) {

	logs, sub, err := _Comptroller.contract.FilterLogs(opts, "NewReserveGuardian")
	if err != nil {
		return nil, err
	}
	return &ComptrollerNewReserveGuardianIterator{contract: _Comptroller.contract, event: "NewReserveGuardian", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event NewReserveGuardian(address oldReserveGuardian, address newReserveGuardian)
func (_Comptroller *ComptrollerFilterer) WatchNewReserveGuardian(opts *bind.WatchOpts, sink chan<- *ComptrollerNewReserveGuardian) (event.Subscription, error) {

	logs, sub, err := _Comptroller.contract.WatchLogs(opts, "NewReserveGuardian")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ComptrollerNewReserveGuardian)
				if err := _Comptroller.contract.UnpackLog(event, "NewReserveGuardian", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event NewReserveGuardian(address oldReserveGuardian, address newReserveGuardian)
func (_Comptroller *ComptrollerFilterer) ParseNewReserveGuardian(log types.Log) (*ComptrollerNewReserveGuardian, error) {
	event := new(ComptrollerNewReserveGuardian)
	if err := _Comptroller.contract.UnpackLog(event, "NewReserveGuardian", log); err != nil {
		return nil, err
	}
...
// ComptrollerNewSpeedGuardianIterator is returned from FilterNewSpeedGuardian and is used to iterate over the raw logs and unpacked data for NewSpeedGuardian events raised by the Comptroller contract.
type ComptrollerNewSpeedGuardianIterator struct {
	Event *ComptrollerNewSpeedGuardian // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *ComptrollerNewSpeedGuardianIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ComptrollerNewSpeedGuardian)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *ComptrollerNewSpeedGuardianIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ComptrollerNewSpeedGuardianIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// ComptrollerNewSpeedGuardian represents a NewSpeedGuardian event raised by the Comptroller contract.
type ComptrollerNewSpeedGuardian struct {
	OldSpeedGuardian common.Address
	NewSpeedGuardian common.Address
	Raw              types.Log // Blockchain specific contextual infos
}

// FilterNewSpeedGuardian is a free log retrieval operation binding the contract event 0x66b9e2e15143d2befba0824e2534258f5cfcf1c4ed53def0733e7cb2429ee83c.
//
// Solidity: event NewSpeedGuardian(address oldSpeedGuardian, address newSpeedGuardian)
func (_Comptroller *ComptrollerFilterer) FilterNewSpeedGuardian(opts *bind.FilterOpts) (*ComptrollerNewSpeedGuardianIterator, error) {

	logs, sub, err := _Comptroller.contract.FilterLogs(opts, "NewSpeedGuardian")
	if err != nil {
		return nil, err
	}
	return &ComptrollerNewSpeedGuardianIterator{contract: _Comptroller.contract, event: "NewSpeedGuardian", logs: logs, sub: sub}, nil
}

// WatchNewSpeedGuardian is a free log subscription operation binding the contract event 0x66b9e2e15143d2befba0824e2534258f5cfcf1c4ed53def0733e7cb2429ee83c.
//
// Solidity: event NewSpeedGuardian(address oldSpeedGuardian, address newSpeedGuardian)
func (_Comptroller *ComptrollerFilterer) WatchNewSpeedGuardian(opts *bind.WatchOpts, sink chan<- *ComptrollerNewSpeedGuardian) (event.Subscription, error) {

	logs, sub, err := _Comptroller.contract.WatchLogs(opts, "NewSpeedGuardian")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ComptrollerNewSpeedGuardian)
				if err := _Comptroller.contract.UnpackLog(event, "NewSpeedGuardian", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParseNewSpeedGuardian is a log parse operation binding the contract event 0x66b9e2e15143d2befba0824e2534258f5cfcf1c4ed53def0733e7cb2429ee83c.
//
// Solidity: event NewSpeedGuardian(address oldSpeedGuardian, address newSpeedGuardian)
func (_Comptroller *ComptrollerFilterer) ParseNewSpeedGuardian(log types.Log) (*ComptrollerNewSpeedGuardian, error) {
	event := new(ComptrollerNewSpeedGuardian)
	if err := _Comptroller.contract.UnpackLog(event, "NewSpeedGuardian", log); err != nil {
		return nil, err
	}
