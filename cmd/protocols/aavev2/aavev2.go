...
// func (a *AaveV2) getTokenSpecs(symbols []string, getAPY func(*AaveV2ReserveData) *big.Int) ([]*t.MarketInfo, error) {
...
// 		tokenSpecs = append(tokenSpecs, &t.MarketInfo{
// 			Protocol: AaveV2Name,
// 			Chain:    a.chain,
// 			Token:    symbols[i],
// 			LTV:      ltv,
...
// func (a *AaveV2) GetLendingSpecs(symbols []string) ([]*t.MarketInfo, error) {
// 	return a.getTokenSpecs(symbols, getLendingAPYV2)
// }

// func (a *AaveV2) GetBorrowingSpecs(symbols []string) ([]*t.MarketInfo, error) {
// 	return a.getTokenSpecs(symbols, getBorrowingAPYV2)
// }

// // Returns the market.
// // Assumes lending and borrowing tokens are the same.
// func (a *AaveV2) GetMarkets() (*t.ProtocolChain, error) {
...
// 		Protocol:      AaveV2Name,
// 		Chain:         a.chain,
// 		SupplyMarkets: lendingSpecs,
// 		BorrowMarkets: borrowingSpecs,
// 	}, nil
// }
