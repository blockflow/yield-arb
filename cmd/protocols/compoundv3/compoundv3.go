...
// func (c *CompoundV3) GetLendingSpecs(symbols []string) ([]*t.MarketInfo, error) {
...
// 	result := make([]*t.MarketInfo, len(symbols))
...
// func (c *CompoundV3) GetBorrowingSpecs(symbols []string) ([]*t.MarketInfo, error) {
...
// 	supplySpecs := make([]*t.MarketInfo, len(allAssetInfos)+1)
...
// 	}
// 	supplySpecs[len(allAssetInfos)] = &t.MarketInfo{
// 		Protocol: CompoundV3Name,
// 		Chain:    c.chain,
// 		Token:    c.baseToken,
// 		LTV:      big.NewFloat(0),
...
// 		Protocol:      CompoundV3Name,
// 		Chain:         c.chain,
// 		SupplyMarkets: supplySpecs,
// 		BorrowMarkets: borrowSpecs,
// 	}, nil
// }
